...
const VoucherTableRow = ({
  ...
  return (
    <tr
      className="record-row group odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700"
      product-id={1}
      row-id="d698d723-4548-4468-ad6a-65b654c86c22"
    >
      <td className="record-index px-6 py-4">{index + 1}</td>
      <th
        scope="row"
      ...
      <td className="px-6 py-4 text-end">
        ...
        className="quantity-sub pointer-events-none group-hover:pointer-events-auto opacity-0 group-hover:opacity-100 translate-x-6 group-hover:translate-x-0 duration-200 bg-blue-100 text-blue-600 p-1 rounded">
          <svg
        ...
        <span className="record-quantity w-10 inline-block ">{quantity}</span>
        <button
      ...
      <td className="record-cost px-6 py-4 text-end">
